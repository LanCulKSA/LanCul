...
(function() {
  var extra = {
    ...
    sf_all:{ar:'الكل', en:'All', es:'Todo', fr:'Tout', it:'Tutto', pt:'Todos', zh:'全部', ja:'すべて', ko:'전체', de:'Alle', ru:'Все'},
    sf_with_pkg:{ar:'مع باقات', en:'With Packages', es:'Con paquetes', fr:'Avec forfaits', it:'Con pacchetti', pt:'Com pacotes', zh:'含套餐', ja:'パッケージあり', ko:'패키지 포함', de:'Mit Paketen', ru:'С пакетами'},
    sf_no_pkg:{ar:'بدون باقات', en:'No Packages', es:'Sin paquetes', fr:'Sans forfaits', it:'Senza pacchetti', pt:'Sem pacotes', zh:'无套餐', ja:'パッケージなし', ko:'패키지 없음', de:'Ohne Pakete', ru:'Без пакетов'},
    has_packages:{ar:'يمتلك باقات سياحية', en:'Has tour packages', es:'Tiene paquetes turísticos', fr:'A des forfaits touristiques', it:'Ha pacchetti turistici', pt:'Tem pacotes turísticos', zh:'含旅游套餐', ja:'ツアーパッケージあり', ko:'투어 패키지 있음', de:'Hat Tourpakete', ru:'Есть турпакеты'},
    svc_companion:{ar:'🤝 مرافق', en:'🤝 Companion', es:'🤝 Acompañante', fr:'🤝 Accompagnateur', it:'🤝 Accompagnatore', pt:'🤝 Acompanhante', zh:'🤝 陪同', ja:'🤝 同行者', ko:'🤝 동반자', de:'🤝 Begleiter', ru:'🤝 Сопровождающий'},
    rfq_corporate:{ar:'وفود الأعمال', en:'Business Delegations', es:'Delegaciones de negocios', fr:"Délégations d'affaires", it:'Delegazioni aziendali', pt:'Delegações de negócios', zh:'商务代表团', ja:'ビジネス代表団', ko:'비즈니스 대표단', de:'Geschäftsdelegationen', ru:'Деловые делегации'},
    rfq_corporate_desc:{ar:'اجتماعات ومفاوضات', en:'Meetings & negotiations', es:'Reuniones y negociaciones', fr:'Réunions et négociations', it:'Riunioni e negoziazioni', pt:'Reuniões e negociações', zh:'会议与谈判', ja:'会議・交渉', ko:'회의 및 협상', de:'Meetings & Verhandlungen', ru:'Встречи и переговоры'},
    rfq_events:{ar:'معارض وفعاليات', en:'Exhibitions & Events', es:'Exposiciones y eventos', fr:'Expositions et événements', it:'Fiere ed eventi', pt:'Feiras e eventos', zh:'展览与活动', ja:'展示会・イベント', ko:'전시회 및 이벤트', de:'Ausstellungen & Events', ru:'Выставки и мероприятия'},
    rfq_events_desc:{ar:'مرافقة دولية', en:'International accompaniment', es:'Acompañamiento internacional', fr:'Accompagnement international', it:'Accompagnamento internazionale', pt:'Acompanhamento internacional', zh:'国际陪同', ja:'国際的な同行', ko:'국제 동행', de:'Internationale Begleitung', ru:'Международное сопровождение'},
    rfq_academic:{ar:'مؤتمرات أكاديمية', en:'Academic Conferences', es:'Conferencias académicas', fr:'Conférences académiques', it:'Conferenze accademiche', pt:'Conferências acadêmicas', zh:'学术会议', ja:'学術会議', ko:'학술 컨퍼런스', de:'Akademische Konferenzen', ru:'Академические конференции'},
    rfq_academic_desc:{ar:'ترجمة علمية', en:'Scientific translation', es:'Traducción científica', fr:'Traduction scientifique', it:'Traduzione scientifica', pt:'Tradução científica', zh:'科学翻译', ja:'科学的翻訳', ko:'과학 번역', de:'Wissenschaftliche Übersetzung', ru:'Научный перевод'},
    rfq_diplomatic:{ar:'وفود دبلوماسية', en:'Diplomatic Delegations', es:'Delegaciones diplomáticas', fr:'Délégations diplomatiques', it:'Delegazioni diplomatiche', pt:'Delegações diplomáticas', zh:'外交代表团', ja:'外交代表団', ko:'외교 대표단', de:'Diplomatische Delegationen', ru:'Дипломатические делегации'},
    rfq_diplomatic_desc:{ar:'مرافقة رسمية', en:'Official accompaniment', es:'Acompañamiento oficial', fr:'Accompagnement officiel', it:'Accompagnamento ufficiale', pt:'Acompanhamento oficial', zh:'官方陪同', ja:'公式同行', ko:'공식 동행', de:'Offizielle Begleitung', ru:'Официальное сопровождение'},
    spec_business:{ar:'أعمال', en:'Business', es:'Negocios', fr:'Affaires', it:'Affari', pt:'Negócios', zh:'商务', ja:'ビジネス', ko:'비즈니스', de:'Geschäft', ru:'Бизнес'},
    spec_medical:{ar:'طب', en:'Medical', es:'Médico', fr:'Médical', it:'Medico', pt:'Médico', zh:'医疗', ja:'医療', ko:'의료', de:'Medizin', ru:'Медицина'},
    spec_diploma:{ar:'دبلوماسية', en:'Diplomacy', es:'Diplomacia', fr:'Diplomatie', it:'Diplomazia', pt:'Diplomacia', zh:'外交', ja:'外交', ko:'외교', de:'Diplomatie', ru:'Дипломатия'},
    spec_heritage:{ar:'تراث', en:'Heritage', es:'Patrimonio', fr:'Patrimoine', it:'Patrimonio', pt:'Patrimônio', zh:'遗产', ja:'文化遺産', ko:'유산', de:'Kulturerbe', ru:'Наследие'},
    spec_tech:{ar:'تقنية', en:'Technology', es:'Tecnología', fr:'Technologie', it:'Tecnologia', pt:'Tecnologia', zh:'技术', ja:'テクノロジー', ko:'기술', de:'Technologie', ru:'Технологии'},
    prov_cta_title:{ar:'🎯 أنت مرشد سعودي؟', en:'🎯 Are you a Saudi Expert?', es:'🎯 ¿Eres un experto saudí?', fr:'🎯 Êtes-vous un expert saoudien ?', it:'🎯 Sei un esperto saudita?', pt:'🎯 Você é um especialista saudita?', zh:'🎯 您是沙特专家吗？', ja:'🎯 サウジの専門家ですか？', ko:'🎯 사우디 전문가이신가요?', de:'🎯 Sind Sie ein saudi. Experte?', ru:'🎯 Вы саудовский эксперт?'},
    prov_cta_sub:{ar:'انضم لشبكة لانكول', en:'Join the LanCul network', es:'Únete a la red LanCul', fr:'Rejoignez le réseau LanCul', it:'Unisciti alla rete LanCul', pt:'Junte-se à rede LanCul', zh:'加入LanCul网络', ja:'LanCulネットワークに参加', ko:'LanCul 네트워크에 참가', de:'Treten Sie dem LanCul-Netzwerk bei', ru:'Присоединитесь к сети LanCul'},
    prov_join_sub:{ar:'انضم وابدأ في كسب الدخل', en:'Join and start earning', es:'Únete y empieza a ganar', fr:'Rejoignez et commencez à gagner', it:'Unisciti e inizia a guadagnare', pt:'Junte-se e comece a ganhar', zh:'加入并开始赚钱', ja:'参加して稼ぎ始める', ko:'참가하고 수입 시작', de:'Beitreten und verdienen', ru:'Присоединяйтесь и начните зарабатывать'},
    btn_register_now:{ar:'سجّل الآن', en:'Register Now', es:'Regístrate ahora', fr:'Inscrivez-vous', it:'Registrati ora', pt:'Cadastre-se agora', zh:'立即注册', ja:'今すぐ登録', ko:'지금 등록', de:'Jetzt registrieren', ru:'Зарегистрируйтесь'},
    step1_of3:{ar:'الخطوة 1 من 3', en:'Step 1 of 3', es:'Paso 1 de 3', fr:'Étape 1 sur 3', it:'Passo 1 di 3', pt:'Passo 1 de 3', zh:'第1步，共3步', ja:'ステップ 1/3', ko:'1/3 단계', de:'Schritt 1 von 3', ru:'Шаг 1 из 3'},
    step2_of3:{ar:'الخطوة 2 من 3', en:'Step 2 of 3', es:'Paso 2 de 3', fr:'Étape 2 sur 3', it:'Passo 2 di 3', pt:'Passo 2 de 3', zh:'第2步，共3步', ja:'ステップ 2/3', ko:'2/3 단계', de:'Schritt 2 von 3', ru:'Шаг 2 из 3'},
    step3_of3:{ar:'الخطوة 3 من 3', en:'Step 3 of 3', es:'Paso 3 de 3', fr:'Étape 3 sur 3', it:'Passo 3 di 3', pt:'Passo 3 de 3', zh:'第3步，共3步', ja:'ステップ 3/3', ko:'3/3 단계', de:'Schritt 3 von 3', ru:'Шаг 3 из 3'},
    lbl_bio:{ar:'نبذة عنك', en:'About You', es:'Sobre ti', fr:'À propos de vous', it:'Su di te', pt:'Sobre você', zh:'关于您', ja:'自己紹介', ko:'자기소개', de:'Über Sie', ru:'О вас'},
    lbl_phone:{ar:'رقم الجوال', en:'Phone Number', es:'Número de teléfono', fr:'Numéro de téléphone', it:'Numero di telefono', pt:'Número de telefone', zh:'手机号码', ja:'電話番号', ko:'전화번호', de:'Telefonnummer', ru:'Номер телефона'},
    lbl_languages:{ar:'اللغات التي تتقنها', en:'Languages You Speak', es:'Idiomas que hablas', fr:'Langues que vous parlez', it:'Lingue che parli', pt:'Idiomas que fala', zh:'您会说的语言', ja:'話せる言語', ko:'구사 언어', de:'Ihre Sprachen', ru:'Языки которые вы знаете'},
    btn_next:{ar:'التالي ←', en:'Next →', es:'Siguiente →', fr:'Suivant →', it:'Avanti →', pt:'Próximo →', zh:'下一步 →', ja:'次へ →', ko:'다음 →', de:'Weiter →', ru:'Далее →'},
    btn_prev:{ar:'→ السابق', en:'← Back', es:'← Atrás', fr:'← Retour', it:'← Indietro', pt:'← Voltar', zh:'← 返回', ja:'← 戻る', ko:'← 뒤로', de:'← Zurück', ru:'← Назад'},
    btn_submit:{ar:'إرسال الطلب', en:'Submit Application', es:'Enviar solicitud', fr:'Soumettre la demande', it:'Invia domanda', pt:'Enviar candidatura', zh:'提交申请', ja:'申込みを送信', ko:'지원서 제출', de:'Bewerbung senden', ru:'Отправить заявку'},
    try_filters:{ar:'جرب تعديل الفلاتر', en:'Try adjusting the filters', es:'Intenta ajustar los filtros', fr:"Essayez d'ajuster les filtres", it:'Prova a modificare i filtri', pt:'Tente ajustar os filtros', zh:'尝试调整筛选条件', ja:'フィルターを調整してみてください', ko:'필터를 조정해 보세요', de:'Versuchen Sie die Filter anzupassen', ru:'Попробуйте изменить фильтры'},
    search_filters:{ar:'فلاتر البحث', en:'Search Filters', es:'Filtros de búsqueda', fr:'Filtres de recherche', it:'Filtri di ricerca', pt:'Filtros de pesquisa', zh:'搜索筛选', ja:'検索フィルター', ko:'검색 필터', de:'Suchfilter', ru:'Фильтры поиска'},
    opt_select:{ar:'اختر', en:'Select', es:'Seleccionar', fr:'Sélectionner', it:'Seleziona', pt:'Selecionar', zh:'选择', ja:'選択', ko:'선택', de:'Auswählen', ru:'Выбрать'},
    l_ms:{ar:'الماليزية', en:'Malay', es:'Malayo', fr:'Malais', it:'Malese', pt:'Malaio', zh:'马来语', ja:'マレー語', ko:'말레이어', de:'Malaiisch', ru:'Малайский'},
    l_tr:{ar:'التركية', en:'Turkish', es:'Turco', fr:'Turc', it:'Turco', pt:'Turco', zh:'土耳其语', ja:'トルコ語', ko:'터키어', de:'Türkisch', ru:'Турецкий'},
    step_basic_info:{ar:'المعلومات الأساسية', en:'Basic Information', es:'Información básica', fr:'Informations de base', it:'Informazioni di base', pt:'Informações básicas', zh:'基本信息', ja:'基本情報', ko:'기본 정보', de:'Grundinformationen', ru:'Основная информация'},
    step_services:{ar:'الخدمات واللغات', en:'Services & Languages', es:'Servicios e idiomas', fr:'Services et langues', it:'Servizi e lingue', pt:'Serviços e idiomas', zh:'服务与语言', ja:'サービスと言語', ko:'서비스 및 언어', de:'Dienste & Sprachen', ru:'Услуги и языки'},
    spec_law:{ar:'قانون', en:'Law', es:'Derecho', fr:'Droit', it:'Diritto', pt:'Direito', zh:'法律', ja:'法律', ko:'법률', de:'Recht', ru:'Право'},
    spec_eng:{ar:'هندسة', en:'Engineering', es:'Ingeniería', fr:'Ingénierie', it:'Ingegneria', pt:'Engenharia', zh:'工程', ja:'工学', ko:'공학', de:'Ingenieurwesen', ru:'Инженерия'},
    spec_edu:{ar:'تعليم', en:'Education', es:'Educación', fr:'Éducation', it:'Istruzione', pt:'Educação', zh:'教育', ja:'教育', ko:'교육', de:'Bildung', ru:'Образование'},
    spec_tourism:{ar:'سياحة', en:'Tourism', es:'Turismo', fr:'Tourisme', it:'Turismo', pt:'Turismo', zh:'旅游', ja:'観光', ko:'관광', de:'Tourismus', ru:'Туризм'},
    providers_hero_title:{ar:'ابحث عن مرشد أو مترجم', en:'Find a Guide or Translator', es:'Encontrar un guía o traductor', fr:'Trouver un guide ou traducteur', it:'Trova una guida o traduttore', pt:'Encontrar um guia ou tradutor', zh:'寻找向导或翻译', ja:'ガイドまたは通訳を探す', ko:'가이드 또는 번역사 찾기', de:'Finden Sie einen Guide', ru:'Найти гида или переводчика'},
    providers_hero_sub:{ar:'+1,000 متخصص سعودي — 20+ لغة عالمية', en:'+1,000 Saudi professionals — 20+ world languages', es:'+1.000 profesionales saudíes — 20+ idiomas', fr:'+1 000 professionnels saoudiens — 20+ langues', it:'+1.000 professionisti sauditi — 20+ lingue', pt:'+1.000 profissionais sauditas — 20+ idiomas', zh:'+1,000名沙特专业人士 — 20+种语言', ja:'+1,000人のサウジ専門家 — 20以上の言語', ko:'+1,000명의 사우디 전문가 — 20개 이상 언어', de:'+1.000 saudi. Fachleute — 20+ Weltsprachen', ru:'+1 000 саудовских специалистов — 20+ языков'},
